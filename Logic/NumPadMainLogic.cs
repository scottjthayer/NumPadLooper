...
using System.IO;
using NumPadLooper.Commands;

namespace NumPadLooper.ViewModel
{
    internal class NumPadMainLogic
    {
        public DelegateCommand _createLibraryCommand { get; private set; }
        public string? libraryPath { get; private set; }
        private CreateLibraryCommand CreateLibraryCommand { get; set; }

        public NumPadMainLogic()
        {
            CreateLibraryCommand= new CreateLibraryCommand();
            _createLibraryCommand = CreateLibraryCommand.InstantiateLibraryCommand();
        }
